...
### change as you like
- docker-compose.yaml
  - use unique survice name
  - change volume folder
  - add mount folder as you like 

- Dockerfile
  - change PROJECT_NAME, USER_NAME, GROUP_NAME

- Makefile
  - change SURVICE_NAME to survice name in docker-compose.yaml
...
### you can also use make file
```bash
$ cd environments/gpu
# docker compose build, up, and exec in all
$ make all
# Create virtual environment and install dependent packages by Poetry
$ poetry install
# use virtural environment
$ poetry shell

#check your cuda version
$ nvcc -V
#make sure to install the version of pytorch that corresponds to your cuda version
